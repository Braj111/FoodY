      ...
      <div className="flex flex-col md:flex-row justify-between gap-10">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2">
            <Input placeholder="Search by Restaurant or Cuisines" type="text" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} />
          ...
          <div>
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:gap-2 my-3">
              <h1 className="font-medium text-lg">({searchedRestaurant?.data.length}) Reasults Found</h1>
              <div className="flex flex-wrap gap-2 mb-4 md:mb-0">
                {
                  appliedFilter.map((selectedFilter: string, idx: number) => (
                    <div key={idx} className="relative inline-flex items-center max-w-full">
                      ...
                      onClick={()=>setAppliedFilter(selectedFilter)} variant="outline">{selectedFilter}
