...
//     price: 80,
//     image: "https://thumbs.dreamstime.com/b/assorted-indian-food-set-wooden-background-dishes-appetisers-indeed-cuisine-rice-lentils-paneer-samosa-spices-mas-masala-179640947.jpg"
// }]
        ...
        <div className="max-w-6xl mx-auto my-10">
            <div className="flex justify-between">
                ...
                <Dialog open={open} onOpenChange={setOpen} >
                    ...
                    <DialogContent>
                        <DialogHeader>
                            <DialogTitle>Add Menus</DialogTitle>
                            <DialogDescription>Create a Menu that makes your Restaurant Stand Out!!!</DialogDescription>
                        </DialogHeader>
                    ...
                    <div key={idx} className="mt-6 space-y-4">
                        <div className="flex flex-col md:flex-row md:items-center md:space-x-4 md:p-4 p-2 shadow-md rounded-lg border">
                            ...
                            <div className="flex-1">
                                <h1 className="text-lg font-semibold text-gray-800 dark:text-white">{menu.name}</h1>
