                        ...
                        <div className="md:grid grid-cols-2 gap-6 space-y-2 md:space-y-0">
                            <div>
                                ...
                                <Input type="text" name="restaurantName" placeholder="Restaurant Name"
                                    value={input.restaurantName} onChange={changeEventHandler} />
                            ...
                            <div>
                                ...
                                <Input type="number" name="deliveryTime" placeholder="Delivery Time"
                            ...
                            <div>
                                ...
                                <Input type="text" name="cuisines" placeholder="e.g. Dal, Roti, Naan"
                                    value={input.cuisines} onChange={(e) => setInput({ ...input, cuisines: e.target.value.split(",") })} />
                        ...
                        <div className="my-5 w-fit">
                            {
                                loading ? (<Button disabled className="bg-orange hover:bg-hoverOrange">
                                    ...
                                    <Button className="bg-orange hover:bg-hoverOrange">{restaurant ? "Update" : "Register"}</Button>
                                )
                            }
                        </div>
                    </form>
