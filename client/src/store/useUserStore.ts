...
const API_END_POINT = "https://foody-6cr4.onrender.com/api/v1/user";
...
export const useUserStore = create<UserState>()(persist((set) => ({
    ...
    //It will check for token inside our cookies, everytime we hit our website, to not prompt user to login again(for 24 hs)
    ...
    //any field can be changed hence type is "any" or "Partial"
